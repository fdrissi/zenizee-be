                  ...
                  <div class="card">
                     <div class="card-body">
                        <?php if (isset($_GET["id"])) {
                           $data = $evmulti
                               ->query(
                                   "select * from tbl_payment_list where id=" . $_GET["id"] . ""
                               )
                               ->fetch_assoc(); ?>
                        <form method="POST" enctype="multipart/form-data">
                           <div class="form-group mb-3">
                              <label>Payment Gateway Name</label>
                              <input type="text" class="form-control " disabled placeholder="Enter Payment Gateway Name"
                               value="<?php echo $data[
                                 "title"
                                 ]; ?>" name="cname" required="">
                           ...
                           <div class="form-group mb-3">
                              ...
                              <input type="text" class="form-control" placeholder="Enter Payment Gateway SubTitle"
                               value="<?php echo $data[
                                 "subtitle"
                                 ]; ?>" name="ptitle" required="">
                           </div>
                           <div class="form-group mb-3">
                              ...
                              <div class="custom-file">
                                 ...
                                 <br>
                                 <img src="<?php echo $data["img"]; ?>" width="100" height="100" alt=""/>
                              </div>
                           </div>
                           <div class="form-group mb-3">
                              <label>Payment Gateway Attributes<?php if (
                                 $_GET["id"] == 1
                                 ) {
                                 echo " ( 1 for Live Paypal And 0 for Sendbox Paypal. )";
                                 } ?></label>
                              <input type="text" class="form-control"  data-role="tagsinput" value="<?php echo $data[
                                 "attributes"
                                 ]; ?>" name="p_attr"  required="">
                           </div>
                           <div class="form-group mb-3">
                           ...
                           <div class="form-group mb-3">
                              ...
                              <select name="p_show" class="form-control">
                                 <option value="1" <?php if ($data["p_show"] == 1) {
                                    echo "selected";
                                    } ?>>Yes</option>
                                 <option value="0" <?php if ($data["p_show"] == 0) {
                                    echo "selected";
                                    } ?> >No</option>
                              </select>
                           </div>
