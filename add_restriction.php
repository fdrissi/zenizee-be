<?php include "filemanager/head.php"; ?>
<!-- loader ends-->
<!-- tap on top starts-->
               ...
               <div class="col-sm-12">
                  <div class="card">
                     <?php if (isset($_GET["id"])) {
                        $data = $evmulti
                            ->query(
                                "select * from tbl_restriction where id=" .
                                    $_GET["id"] .
                                    ""
                            )
                            ->fetch_assoc(); ?>
                     <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-footer text-left">
                           <button  class="btn btn-primary">Edit  Restriction</button>
                        </div>
                     </form>
                     <?php
                        } else {
                     ...
                     <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-footer text-left">
                           <button  class="btn btn-primary">Add Restriction</button>
                        </div>
                     </form>
                     <?php
                        } ?>
